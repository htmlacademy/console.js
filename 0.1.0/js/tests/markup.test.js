...
class Console {
  ...
  constructor(container, params = {}) {
    ...
    this.params = {
      object: this._parseParams(lodash_mergewith({}, params.common, params.object, customizer)),
      array: this._parseParams(lodash_mergewith({}, params.common, params.array, customizer)),
      function: this._parseParams(lodash_mergewith({}, params.common, params.function, customizer)),
      env: params.env
    };
  }
