(function () {
  ...
  var acorn$1 = unwrapExports(acorn);

  var misbehave = createCommonjsModule(function (module, exports) {
  (function (global, factory) {
  ...
  var specialKeysMap = createCommonjsModule$$1(function (module) {
  /**
  ...
  var undomanager = createCommonjsModule$$1(function (module) {
  /*
  ...
  */
  ...
  var PromptView = /*#__PURE__*/function (_AbstractView) {
    _inherits(PromptView, _AbstractView);

    var _super = _createSuper(PromptView);

    function PromptView(isMobile) {
      var _this;
    ...
    _createClass(PromptView, [{
      ...
      value: function _bind() {
        ...
        this._sendBtnEl.addEventListener("touchstart", function () {}, {
          passive: true
        }); // Чтобы :active на кнопку отправки работал на мобильных устройствах
      ...
      key: "_handleMisbehaveInput",
      value: function _handleMisbehaveInput(text) {
        if (emtyRE.test(text)) {
          this._inputEl.innerText = "";
        } else {
          this._inputEl.innerHTML = prismCore.highlight(text, prismCore.languages.javascript);
        }
      }
    }, {
      key: "_handleKeyDown",
      ...
      key: "_handleSendClick",
      value: function _handleSendClick() {
        this._send();
      }
    }, {
      ...
      key: "createScriptFromCodeAndAppend",
      value: function createScriptFromCodeAndAppend(code) {
        var _this2 = this;
        ...
        script.onload = function () {
          _this2._scriptsEl.removeChild(script);
  ...
  var Prompt = /*#__PURE__*/function () {
    function Prompt(container, consoleGlobalName) {
    ...
    _createClass(Prompt, [{
      ...
      key: "_handleSend",
      value: function _handleSend(code, highlightedMarkup) {
        var ast = acorn$1.parse(code);
        var body = ast.body;
        var l = body.length;
        var lastExpressionStatementNode;
        ...
        if (lastExpressionStatementNode) {
          var expression = lastExpressionStatementNode.expression;
          var leftStrPart = code.substring(0, expression.start);
          var rightStrPart = code.substring(expression.end, code.length);
          var exprStrPart = code.substring(expression.start, expression.end);
          editedCode = "".concat(leftStrPart, ";").concat(this._consGlobalName, ".logOutput(").concat(exprStrPart, ");").concat(rightStrPart);
        } else {
          editedCode = "".concat(code, ";").concat(this._consGlobalName, ".logOutput(void 0);");
        }
...
//# sourceMappingURL=index-prompt.js.map
